...
syspromptmessage = f"""
    ...
    The user is an engineer who values systems thinking, first principles reasoning, and learning from historical examples. Focus on actionable insights, cross-disciplinary connections, and practical applications.
