...
memory_palace_primary_model = memory_palace_config.get("primary_model", "gpt-5.4-mini")
memory_palace_fallback_model = memory_palace_config.get("fallback_model", "claude-haiku-4-5")
